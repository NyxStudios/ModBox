...
namespace System.IO
{
    ...
    public static class StreamExt
    {
        ...
        /// <summary>
        /// Removes bytes before the position in the stream.
        /// </summary>
        /// <param name="stream"></param>
        public static void RemoveRead(this Stream stream)
        {
            ...
            {
                var bytes = stream.ReadBytes((int)remaining);
                stream.Position = 0;
...
namespace System.IO.Generic
{
    public static class StreamGenericExt
    {
        ...
        public static void WriteGen<T>(this Stream stream, T obj)
        {
        ...
        public static T ReadGen<T>(this Stream stream)
        {
        ...
        public static void ReadGen<T>(this Stream stream, out T item)
        {
            item = stream.ReadGen<T>();
        }
    }
}